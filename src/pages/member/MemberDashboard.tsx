...
export default function MemberDashboard() {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="flex items-center justify-between bg-white border-4 border-[#E13D4B] p-4 shadow-[8px_8px_0px_0px_rgba(225,61,75,1)]">
        ...
        <div className="flex items-center gap-6">
          ...
          <button 
            onClick={signOut}
            className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-[#E13D4B]"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border-4 border-[#E13D4B] p-6 shadow-[8px_8px_0px_0px_rgba(225,61,75,1)]">
      ...
      <div className="bg-white border-4 border-[#E13D4B] p-6 shadow-[8px_8px_0px_0px_rgba(225,61,75,1)]">
         ...
         <div className="flex flex-wrap gap-4">
            <button 
              ...
              className="px-8 py-3 bg-[#E13D4B] text-white font-black uppercase text-xs tracking-widest hover:bg-[#E13D4B]/90 transition-all disabled:opacity-30 shadow-[4px_4px_0px_0px_rgba(225,61,75,1)] hover:shadow-none"
            >
              Punch In
            </button>
            <button 
              ...
              className="px-8 py-3 bg-white text-[#E13D4B] border-2 border-[#E13D4B] font-black uppercase text-xs tracking-widest hover:bg-gray-50 transition-all disabled:opacity-30 shadow-[4px_4px_0px_0px_rgba(225,61,75,1)] hover:shadow-none"
            >
              Punch Out
            </button>
            <Link 
              to="/member/my-plans" 
              className="px-8 py-3 bg-white text-[#E13D4B] border-2 border-[#E13D4B] font-black uppercase text-xs tracking-widest hover:bg-gray-50 transition-all shadow-[4px_4px_0px_0px_rgba(225,61,75,1)] hover:shadow-none"
            >
              Renew
            </Link>
            <Link 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Monthly Attendance */}
        <div className="bg-white border-4 border-[#E13D4B] p-8 shadow-[8px_8px_0px_0px_rgba(225,61,75,1)] flex items-center justify-between">
           <div>
           ...
           <div className="w-20 h-20 border-4 border-[#E13D4B] flex items-center justify-center rounded-full bg-rose-50 p-2">
              <Calendar size={32} className="text-[#E13D4B]" />
           </div>
        </div>

        {/* Diet Plan */}
        <div className="bg-[#E13D4B] text-white p-8 border-4 border-[#E13D4B] shadow-[8px_8px_0px_0px_rgba(225,61,75,1)]">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border-4 border-[#E13D4B] shadow-[8px_8px_0px_0px_rgba(225,61,75,1)]">
           {stats.recentPayments.length > 0 ? stats.recentPayments.map((p, idx) => (
             <div key={idx} className="flex flex-col sm:flex-row sm:items-center justify-between p-6 border-b-2 border-[#E13D4B] last:border-0 hover:bg-rose-50 transition-colors">
                ...
                <Link 
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2 border-2 border-[#E13D4B] text-[10px] font-black uppercase tracking-widest hover:bg-[#E13D4B] hover:text-white transition-all shadow-[4px_4px_0px_0px_rgba(225,61,75,1)] hover:shadow-none"
                >
                  [Receipt]
                </Link>
             </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border-4 border-[#E13D4B] shadow-[8px_8px_0px_0px_rgba(225,61,75,1)]">
           {stats.notifications.length > 0 ? stats.notifications.map((n, idx) => (
             <div key={idx} className="p-6 border-b-2 border-[#E13D4B] last:border-0 hover:bg-gray-50 transition-colors flex items-start gap-4">
      ...
      <div className="md:hidden flex items-center justify-around bg-white border-t-4 border-[#E13D4B] fixed bottom-0 left-0 right-0 p-4 z-[55]">
         <Link to="/member/dashboard" className="flex flex-col items-center gap-1 text-[#E13D4B]">
           <LayoutDashboard size={20} />
           <span className="text-[8px] font-black uppercase">Home</span>
         </Link>
         <Link to="/member/profile" className="flex flex-col items-center gap-1 text-gray-400">
           <User size={20} />
         ...
         <button onClick={signOut} className="flex flex-col items-center gap-1 text-gray-400">
           <LogOut size={20} />
