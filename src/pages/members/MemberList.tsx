      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          ...
          <button 
            ...
            className="px-6 py-2 bg-[#E13D4B] text-white text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-[#E13D4B]/90 transition-all shadow-lg shadow-rose-100"
          >
            Filter
          </button>
        </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  ...
                  <button 
                    ...
                    className="flex lg:flex-row flex-col items-center justify-center gap-2 px-3 py-2 bg-[#E13D4B] text-white text-[10px] font-bold uppercase tracking-wider rounded-lg hover:bg-[#E13D4B]/90 transition-colors shadow-sm"
                  >
